...
//         let _1 := 0x20
//         let t2_x_2 := calldataload(add(t2, _1))
...
//         if or(or(or(or(or(or(or(iszero(t2_x), iszero(t2_x_2)), iszero(t2_y)), iszero(t2_y_2)), eq(t2_x, _5)), eq(t2_x_2, _4)), eq(t2_y, _3)), eq(t2_y_2, _2))
//         {
//             mstore(0x00, 400)
//             revert(0x00, _1)
//         }
