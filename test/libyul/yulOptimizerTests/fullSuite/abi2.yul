...
//         revert(0, 0)
//     }
//     sstore(0, and(calldataload(_3), 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF))
//     let x0, x1, x2, x3, x4 := abi_decode_tuple_t_addresst_uint256t_bytes_calldata_ptrt_enum$_Operation_$1949(mload(7), mload(8))
//     sstore(x1, x0)
//     sstore(x3, x2)
//     sstore(1, x4)
...
//             revert(value4, value4)
//         }
//         let _5 := add(headStart_55, offset)
//         if iszero(slt(add(_5, 0x1f), dataEnd_56))
//         {
//             revert(value4, value4)
//         }
//         let abi_decode_length := calldataload(_5)
//         if gt(abi_decode_length, _4)
//         {
//             revert(value4, value4)
//         }
//         if gt(add(add(_5, abi_decode_length), 32), dataEnd_56)
//         {
//             revert(value4, value4)
//         }
//         value2_59 := add(_5, 32)
//         value3 := abi_decode_length
//         let _6 := calldataload(add(headStart_55, 96))
//         if iszero(lt(_6, 3))
//         {
//             revert(value4, value4)
//         }
...
//         let _7 := 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
//         mstore(add(headStart_252, 32), and(value1_262, _7))
...
//         mstore(add(headStart_252, 256), and(value8_255, _7))
//         mstore(add(headStart_252, 288), and(value9_254, _7))
